...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_images2(self):
        matches = extract_markdown_images(
            "This is text with both an ![image](https://i.imgur.com/zjjcJKZ.png) and a [link](https://youtube.com)"
        )
        self.assertListEqual([("image", "https://i.imgur.com/zjjcJKZ.png")], matches)
    ...
    def test_split_links_same(self):
        node = TextNode(
            "This is text with [a link](https://www.google.com) and another identical [link](https://www.google.com)",
            TextType.TEXT
        )
        new_nodes = split_nodes_link([node])
        self.assertListEqual(
            [
                ...
                TextNode(" and another identical ", TextType.TEXT),
